(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max, 300, 270, 7, 0.9);
        collectable.create(type.db, 400, 370, 8, 0.11);
        collectable.create(type.grace, 500, 470, 9, 0.14);
        collectable.create(type.kennedi, 600, 570, 10, 0.15);
